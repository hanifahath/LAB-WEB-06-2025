{{-- resources/views/fishes/edit.blade.php --}}
@extends('layouts.app')

@section('title', 'Edit Data Ikan: ' . $fish->name)

@section('content')
<div class="card card-ocean shadow mb-4">
    <div class="card-header card-header-ocean">
        <h5>✏️ Form Edit Data Ikan: <span class="text-warning">{{ $fish->name }}</span></h5>
    </div>
    <div class="card-body">
        ...
        <form action="{{ route('fishes.update', $fish->id) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-4">
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" 
                              ...
                              placeholder="Masukkan deskripsi ikan...">{{ old('description', $fish->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="alert alert-warning border-0 mb-4">
                ...
                <ul class="mb-0 mt-2">
                    ...
                    <li>Perubahan akan langsung tersimpan setelah klik tombol Update</li>
                </ul>
            </div>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('fishes.show', $fish->id) }}" class="btn btn-info px-4">
                    👁️ Lihat Detail
                </a>
